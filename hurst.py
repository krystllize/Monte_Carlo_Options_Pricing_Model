...
#Raw Data goes here in ascending order - sample data here is taken from S&P 500's historical returns from 
raw_data = [4343.54,4358.13,4320.82,4369.55,4384.63,4369.21,4374.3,4360.03,4327.16,4258.63,4323.21,4358.69,4367.48,4411.8,4422.23,4401.46,4400.65,4419.15,4395.26,4387.11,4423.15,4402.68,4429.1,4436.52,4432.35,4436.75,4447.7,4460.84,4468,4479.66,4448.08,4400.27,4405.8,4441.67,4479.54,4486.23,4496.19,4469.91,4509.37,4528.79,4522.68,4524.09,4536.95,4535.43,4520.03,4514.07,4493.28,4458.58,4468.73,4443.05,4480.7,4473.76,4432.99,4357.73,4354.18,4395.64,4448.98,4455.48,4443.11,4352.63,4359.46,4307.54,4357.05,4300.46,4345.72,4363.55,4399.76,4391.36,4361.19,4350.64,4363.8,4438.23,4471.37,4486.48,4519.63,4536.19,4549.78,4544.9,4566.48,4574.79,4551.68,4596.42,4605.38,4613.67,4630.65,4660.57,4680.06,4697.53,4701.7,4685.25,4646.71,4649.27,4682.85,4682.81,4700.9,4688.67,4706.64,4697.96,4682.95,4690.7,4701.46,4594.62,4655.27,4567,4513.04,4577.1,4538.43,4591.67,4686.75,4701.21,4667.45,4712.02,4669.15,4634.09,4709.84,4668.67,4620.64,4568.02,4649.23,4696.56,4725.78,4791.19,4786.36,4793.06,4778.73,4766.18,4796.56,4793.54,4700.58,4696.05,4677.02,4670.29,4713.07,4726.35,4659.02,4662.85,4577.34,4532.76,4482.73,4397.93,4410.13,4356.45,4349.93,4326.5,4431.85,4515.55,4546.54,4589.32,4477.44,4500.54,4483.87,4521.54,4587.18,4504.06,4418.64,4401.67,4471.07,4475.01,4380.26,4348.87,4304.74,4225.5,4288.7,4384.62,4373.79,4306.26,4386.54,4363.49,4328.87,4201.09,4170.62,4277.88,4259.52,4204.31,4173.11,4262.45,4357.95,4411.67,4463.09,4461.18,4511.61,4456.23,4520.16,4543.04,4575.52,4631.6,4602.45,4530.41,4545.86,4582.64,4525.12,4481.15,4500.21,4488.28,4412.53,4397.45,4446.59,4392.59,4391.69,4462.21,4459.45,4393.66,4271.78,4296.12,4175.2,4183.96,4287.5,4131.93,4155.38,4175.48,4300.17,4152.38,4123.34,3991.24,4001.05,3935.18,3930.08,4023.89,4008.01,4088.85,3923.68,3900.79,3901.36,3973.75,3941.48,3978.73,4057.84,4158.24,4132.15,4101.23,4176.82,4108.54,4121.43,4160.68,4115.77,4017.82,3900.86,3749.63,3735.48,3789.99,3666.77,3674.84,3764.79,3759.89,3795.73,3911.74,3900.11,3821.55,3818.83,3785.38,3825.33,3831.39,3845.08,3902.62,3899.38,3854.43,3818.8,3801.78,3790.38,3863.16,3830.85,3936.69,3959.9,3998.95,3961.63,3966.84,3921.05,4023.61,4072.43,4130.29,4118.63,4091.19]

getcontext().prec = 5 #Calculated values in the program should be rounded to 5 decimal places

returns_data = []
for l in range(1,len(raw_data)):
    returns_data.append((raw_data[l]-raw_data[l-1])/(raw_data[l-1]))
...
class Hurst:
    ...
    def log_x_values(self):
        for i in range(len(self.average_chunk_lengths)):
            self.log_x.append(Decimal(self.average_chunk_lengths[i]).ln()) #Use logarithm with base 10
        return self.log_x
...
t = table.log_x_values()
table.log_y_values()
print("The logarithm values can be viewed in the table below:")
print(table.log_table())

print(f"The Hurst exponent of the given data series is {table.hurst_exponent()}.")